...
ISearch::SearchResult ISearch::startSearch(ILogger *Logger, const Map &map, const EnvironmentOptions &options)
{
    ...
    while (!stopCriterion()) {
        ...
        std::list<AstarNode> successors = findSuccessors(curNode, map, options);
        std::list<AstarNode>::iterator it = successors.begin();
...
std::list<AstarNode> ISearch::findSuccessors(AstarNode curNode, const Map &map, const EnvironmentOptions &options)
{
    AstarNode newNode;
...
void ISearch::makePrimaryPath(AstarNode curNode)
{
    AstarNode current = curNode;
...
{
    std::list<AstarNode>::const_iterator iter = lppath.begin();
...
void ISearch::addOpen(AstarNode newNode)
{
    std::list<AstarNode>::iterator iter, pos;
